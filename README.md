# ECI37_N1 - Functional Approach to EDSLs

Course "Abordaje Funcional a EDSLs" taught by [Alberto Pardo](https://www.fing.edu.uy/~pardo/) and [Marcos Viera](https://www.fing.edu.uy/~mviera/) during [ECI](https://eci.dc.uba.ar/) in 2024.

## Structure

In this repository the following files are available:
- Notes taken about the course content (found in `apunte`).
